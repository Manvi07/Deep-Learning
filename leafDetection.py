...
name = os.listdir("../Day2/Codes/Data/train/0/")
input_images = []
output_images = []
print("loading_images")
count =0

print("../Day2/Codes/Data/train/0/" + str(5)+".png")
for i in name[:1000]:
    if os.path.exists("../Day2/Codes/Data/train/0/"+str(i)):
        img_X = cv2.imread("../Day2/Codes/Data/train/0/"+str(i), 0 )
        # plt.imshow(img_X, cmap='gray')
        # print(str(i))
        img_X = cv2.resize(img_X, (256, 256))
        img_X = img_X[:, :, np.newaxis]
        # img_X = img_X.reshape(256, 256, 1)
        # print(img_X.shape)
        input_images.append(img_X)
        img_y = cv2.imread("../Day2/Codes/Data/train/0/"+str(i), 0)
